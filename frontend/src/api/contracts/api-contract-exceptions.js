...
export const API_CONTRACT_EXCEPTIONS = Object.freeze({
  ...
  "/usage/available-months/": {
    ...
    reason:
      "Usage billing available-months endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/create-topup-session/": {
    group: "usage",
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Top-up billing endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise billing endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/billing-overview/": {
    group: "usage",
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 billing overview endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/budgets/": {
    group: "usage",
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 budgets endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/budgets/{id}/": {
    group: "usage",
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 budget detail endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/invoices/": {
    group: "usage",
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 invoices endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/invoices/{id}/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 invoice detail endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/notifications/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 notifications endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/plans-and-addons/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 plans/addons endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/usage-overview/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 overview endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/usage-time-series/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 time-series endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
  "/usage/v2/usage-workspace-breakdown/": {
    ...
    status: API_CONTRACT_EXCEPTION_STATUSES.ENTERPRISE_CONTRACT_PENDING,
    reason:
      "Usage V2 workspace breakdown endpoint is live Enterprise surface and not fully exposed in Swagger yet.",
    next: "Expose the Enterprise usage V2 endpoint to contract generation or move it through an Enterprise contract manifest.",
  },
});
